...
@Component
public class GetFundtransferById implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private GetfundtransfersByIdRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(GetFundtransferById.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+GetFundtransferById.class.getName());
         }else{
